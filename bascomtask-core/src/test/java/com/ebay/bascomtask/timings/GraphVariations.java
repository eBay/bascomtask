...
public class GraphVariations {
    ...
    public static long stacks(long input) {
        ...
        switch (((int)input % 5) + 1) {
            case 1: $.execute(left1,right1); break;
            case 2: $.execute(left2,right2); break;
            case 3: $.execute(left3,right3); break;
            case 4: $.execute(left4,right4); break;
            case 5: $.execute(left5,right5); break;
            default: // do nothing
        }
